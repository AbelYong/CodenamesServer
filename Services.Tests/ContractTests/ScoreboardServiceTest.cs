...
namespace Services.Tests.ContractTests
{
    ...
    public class ScoreboardServiceTest
    {
        ...
        public void GetMyScore_PlayerExists_ReturnsCorrectUsername()
        {
            ...
            _scoreboardDaoMock.Setup(d => d.GetPlayerScoreboard(playerId)).Returns(dbScoreboard);
        ...
        {
            Guid playerId = Guid.NewGuid();
            _scoreboardDaoMock.Setup(d => d.GetPlayerScoreboard(playerId)).Returns((DataAccess.Scoreboard)null);
        ...
        public void GetTopPlayers_Success_ReturnsPopulatedList()
        {
            ...
            _scoreboardDaoMock.Setup(d => d.GetTopPlayersByWins(10)).Returns(daoResponse);
        ...
        public void NotifyMatchConcluded_DbError_DoesNotNotify()
        {
            ...
            _scoreboardDaoMock.SetupSequence(d => d.GetTopPlayersByWins(10))
