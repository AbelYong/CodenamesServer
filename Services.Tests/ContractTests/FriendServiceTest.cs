...
namespace Services.Tests.ContractTests
{
    ...
    public class FriendServiceTest
    {
        ...
        public void SendFriendRequest_ValidRequest_ReturnsSuccess()
        {
            ...
            _friendRepositoryMock.Setup(d => d.SendFriendRequest(fromId, toId))
        ...
        public void AcceptFriendRequest_ValidRequest_ReturnsSuccess()
        {
            ...
            _friendRepositoryMock.Setup(d => d.AcceptFriendRequest(meId, requesterId))
                .Returns(new OperationResult { Success = true });
        ...
        public void RejectFriendRequest_ValidRequest_ReturnsSuccess()
        {
            Guid meId = Guid.NewGuid();
            Guid requesterId = Guid.NewGuid();
            _friendRepositoryMock.Setup(d => d.RejectFriendRequest(meId, requesterId))
                .Returns(new OperationResult { Success = true });
            var mePlayer = CreateDataAccessPlayer(meId, "Me");
            _playerRepositoryMock.Setup(p => p.GetPlayerById(meId)).Returns(mePlayer);
            var callback = CreateMockCallback();
        ...
        public void RemoveFriend_ValidRequest_ReturnsSuccess()
        {
            ...
            _friendRepositoryMock.Setup(d => d.RemoveFriend(meId, friendId))
                .Returns(new OperationResult { Success = true });
            var mePlayer = CreateDataAccessPlayer(meId, "Me");
            _playerRepositoryMock.Setup(p => p.GetPlayerById(meId)).Returns(mePlayer);
            var callback = CreateMockCallback();
        ...
        public void SearchPlayers_ValidQuery_ReturnsFilteredList()
        {
            ...
            _friendRepositoryMock.Setup(d => d.SearchPlayers(query, meId, 20)).Returns(response);
        ...
        public void SearchPlayers_DaoFails_ReturnsDbError()
        {
            ...
            _friendRepositoryMock.Setup(d => d.SearchPlayers(It.IsAny<string>(), It.IsAny<Guid>(), It.IsAny<int>()))
                .Returns(response);
        ...
        public void GetFriends_FriendsExist_ReturnsList()
        {
            ...
            _friendRepositoryMock.Setup(d => d.GetFriends(meId)).Returns(response);
        ...
        {
            var response = new PlayerListRequest { IsSuccess = false, ErrorType = ErrorType.DB_ERROR };
            _friendRepositoryMock.Setup(d => d.GetFriends(It.IsAny<Guid>())).Returns(response);
        ...
        public void GetIncomingRequests_RequestsExist_ReturnsList()
        {
            ...
            _friendRepositoryMock.Setup(d => d.GetIncomingRequests(meId)).Returns(response);
        ...
        {
            var response = new PlayerListRequest { IsSuccess = false, ErrorType = ErrorType.DB_ERROR };
            _friendRepositoryMock.Setup(d => d.GetIncomingRequests(It.IsAny<Guid>())).Returns(response);
        ...
        public void GetSentRequests_RequestsExist_ReturnsList()
        {
            ...
            _friendRepositoryMock.Setup(d => d.GetSentRequests(meId)).Returns(response);
        ...
        {
            var response = new PlayerListRequest { IsSuccess = false, ErrorType = ErrorType.DB_ERROR };
            _friendRepositoryMock.Setup(d => d.GetSentRequests(It.IsAny<Guid>())).Returns(response);
